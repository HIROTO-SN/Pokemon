...
export const lal_email_receive_title = "Your Email will be used to verify your account.";
export const p_disp_question_title = "Do you want to display your Pokémon Trainer Club profile publicly? This includes content such as your screen name. Personal information such as your real name is always kept private.";
export const p_continue_warning = " By continuing to use the Services, you acknowledge that you have read, understood, and agree to our ";
